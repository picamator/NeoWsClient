...
use Picamator\NeoWsClient\Mapper\Repository\FeedRepository;
use Picamator\NeoWsClient\Tests\Unit\BaseTest;

class FeedRepositoryTest extends BaseTest
{
    /**
     * @var FeedRepository
     */
    ...
    protected  function setUp()
    {
        ...
        $this->repository = new FeedRepository($this->schemaFactoryMock, $this->repositoryMock);
    }
